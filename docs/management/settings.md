...
1. Navigate to the [Branch protection rules](https://github.com/pvagnozzi/catseyeguard/settings/branches) settings.
...
1. Enable **Require status checks to pass before merging** and set [ci](https://github.com/pvagnozzi/catseyeguard/actions/workflows/ci.yml) and [commitlint](https://github.com/pvagnozzi/catseyeguard/actions/workflows/commitlint.yml) as required status checks.
...
1. Navigate to the [Repository](https://gitlab.com/pvagnozzi/catseyeguard/-/settings/repository) settings and the **Protected branches** section.
...
1. Navigate to the [Protected tags](https://github.com/pvagnozzi/catseyeguard/settings/tag_protection) settings.
...
1. Navigate to the [Repository](https://gitlab.com/pvagnozzi/catseyeguard/-/settings/repository) settings and the **Protected tags** section.
...
1. Navigate to the [General](https://github.com/pvagnozzi/catseyeguard/settings) settings and the **Pull Requests** section.
...
1. Navigate to the [Merge requests](https://gitlab.com/pvagnozzi/catseyeguard/-/settings/merge_requests) settings.
...
1. Navigate to the [GitHub Pages](https://github.com/pvagnozzi/catseyeguard/settings/pages) settings.
...
1. Navigate to the [Actions secrets and variables](https://github.com/pvagnozzi/catseyeguard/settings/secrets/actions) settings.
...
1. Navigate to the [CI/CD](https://gitlab.com/pvagnozzi/catseyeguard/-/settings/ci_cd) settings and the **Variables** section.
...
1. Navigate to the [Actions secrets and variables](https://github.com/pvagnozzi/catseyeguard/settings/secrets/actions) settings and set the token as a **secret** `PAT`.
...
1. Create a [group access token](https://gitlab.com/groups/pvagnozzi/-/settings/access_tokens), [project access token](https://gitlab.com/pvagnozzi/catseyeguard/-/settings/access_tokens) or [personal access token](https://gitlab.com/-/user_settings/personal_access_tokens) with `Maintainer` role and `api, write_repository` scope.
1. Navigate to the [CI/CD](https://gitlab.com/pvagnozzi/catseyeguard/-/settings/ci_cd) settings and the **Variables** section. Set the token as variable `PAT` with the **Mask variable** option for security.
1. Navigate to the [Pipeline schedules](https://gitlab.com/pvagnozzi/catseyeguard/-/pipeline_schedules). Create a new schedule with `*/15 0-3 * * 1` as **Interval Pattern** and mark it as **Activated**.
